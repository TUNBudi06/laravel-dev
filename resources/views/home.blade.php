...
@section('head')
    ...
    <title>TheUnknownName</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x" href="{{asset("home-html/assets/favicon.ico")}}" />
    <!-- Font Awesome icons (free version)-->
    <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
    <!-- Google fonts-->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet" type="text/css" />
    <link href="https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic" rel="stylesheet" type="text/css" />
    <link href="{{asset("home-html/css/styles.css")}}" rel="stylesheet" />
@endsection
...
@section('content')
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5 rounded-circle" src="{{asset("home-html/assets/img/fotoku.png")}}" alt="..." />
            <!-- Masthead Heading-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">BackEnd Developer - Data Science - IT computer</p>
        </div>
    </header>
    <!-- Portfolio Section-->
